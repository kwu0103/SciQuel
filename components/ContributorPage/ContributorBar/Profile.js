            ...
            <article>
                <div className={profileStyles.background}>
                    <div className={profileStyles.center}>
                        <Image className={profileStyles.image} width={200} height={200} src = {image} alt={image}/>
                        ...
                        <Image className = {profileStyles.logo} width={20} height={20} src = {fb} alt={fb}/>
                        <Image className = {profileStyles.logo} width={20} height={20} src = {ins} alt={ins}/>
                    </div>
                </div>
            </article>
        </>
