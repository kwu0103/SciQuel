...
function Figure({
    ...
    if(!CAPTIONPOSITION_OPTIONS.includes(captionPosition)){
        console.log('invalid Figure captionPosition (%s), expected one of %s; using default captionPosition option "%s"', captionPosition, JSON.stringify(CAPTIONPOSITION_OPTIONS), CAPTIONPOSITION_DEFAULT)
